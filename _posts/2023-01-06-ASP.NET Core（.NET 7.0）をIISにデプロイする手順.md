...
+ IISに元からあるDefault Web Site`http:80`にWebアプリケーションを登録する。
  1. IISマネージャーを立ち上げる
  1. アプリケーションプールを追加する
    <br>![イメージ](/blog/assets/img/2023-01-06/アプリケーションプールの追加_asp_net_core.png)
     + 「.Net CLRバージョン」は、「マネージドコードなし」にする
  1. 仮想ディレクトリを追加する
    <br>![イメージ](/blog/assets/img/2023-01-06/仮想ディレクトリの追加.png)
    <br>![イメージ](/blog/assets/img/2023-01-06/仮想ディレクトリの設定_asp_net_core.png)
  ...
  1. アプリケーションに変換する
    ...
    <br>![イメージ](/blog/assets/img/2023-01-06/アプリケーションの追加_asp_net_core.png)
     + 「アプリケーションプール」は、手順2で作成した「SampleWebApplication」を指定する

# トラブルシューティング
+ 500.19エラー
![イメージ](/blog/assets/img/2023-01-06/トラブルシューティング_HTTPエラー500.19_asp_net_core.png)
...
+ 500.35エラー
![イメージ](/blog/assets/img/2023-01-06/トラブルシューティング_HTTPエラー500.35.png)

...
![イメージ](/blog/assets/img/2023-03-02/プロジェクトテンプレート_ワーカーサービス.png)
+ .NET Framework 4.8であれば、「Windowsサービス」を選択する<br>
![イメージ](/blog/assets/img/2023-03-02/プロジェクトテンプレート_Windowsサービス.png)
...
![イメージ](/blog/assets/img/2023-03-02/ワーカーサービス_プロジェクト作成1.png)<br>
プロジェクトのデフォルトの構成は下記のようになっております。<br>
![イメージ](/blog/assets/img/2023-03-02/ワーカーサービス_プロジェクト作成2.png)<br>

### 事前準備
プロジェクトテンプレートのデフォルトのままでは、アプリ`*.exe`をWindowsサービスで実行するとエラーとなります。デスクトップ環境でアプリ`*.exe`を実行するとエラーになりません。<br>
![イメージ](/blog/assets/img/2023-03-02/ワーカーサービス_エラー1053.png)<br>
...
![イメージ](/blog/assets/img/2023-03-02/ワーカーサービスのデバッグ.png)

### アプリ作成
Windowsサービスで実行するアプリ`*.exe`を作成します。<br>
Visual Studioのソリューションエクスプローラーで当該プロジェクトを右クリックして「発行」を選択する。<br>
![イメージ](/blog/assets/img/2023-03-02/ワーカーサービス_アプリの発行1.png)<br>
「フォルダー」を選択して次へ進み、デフォルトのまま完了する。<br>
![イメージ](/blog/assets/img/2023-03-02/ワーカーサービス_アプリの発行2.png)<br>
「発行」をクリックしてアプリ`*.exe`を作成する。<br>
![イメージ](/blog/assets/img/2023-03-02/ワーカーサービス_アプリの発行3.png)<br>
...
```
![イメージ](/blog/assets/img/2023-03-02/ワーカーサービスの登録確認.png)<br>
![イメージ](/blog/assets/img/2023-03-02/ワーカーサービスのプロパティ.png)
...
![イメージ](/blog/assets/img/2023-03-02/Windowsサービス_プロジェクト作成1.png)<br>
プロジェクトのデフォルトの構成は下記のようになっております。<br>
![イメージ](/blog/assets/img/2023-03-02/Windowsサービス_プロジェクト作成2.png)<br>

### 事前知識
.NET Framework 4.8で作成したアプリ`*.exe`はWindowsサービスでないと実行できません。<br>
デスクトップ環境でアプリ`*.exe`を実行するとエラーになります。<br>
![イメージ](/blog/assets/img/2023-03-02/Windowsサービス_開始エラー.png)<br>
...
![イメージ](/blog/assets/img/2023-03-02/Windowsサービス_インストーラの追加1.png)<br>
`ProjectInstaller.cs`が作成されます。<br>
![イメージ](/blog/assets/img/2023-03-02/Windowsサービス_インストーラの追加2.png)<br>
![イメージ](/blog/assets/img/2023-03-02/Windowsサービス_インストーラの追加3.png)<br>
`serviceProcessInstaller1`と`serviceInstaller1`のプロパティでWindowsサービスの設定を指定できます。<br>
![イメージ](/blog/assets/img/2023-03-02/Windowsサービス_インストーラの追加4.png)<br>
![イメージ](/blog/assets/img/2023-03-02/Windowsサービス_インストーラの追加5.png)<br>
...
```
![イメージ](/blog/assets/img/2023-03-02/Windowsサービスの登録確認.png)<br>
![イメージ](/blog/assets/img/2023-03-02/Windowsサービスのプロパティ.png)<br>

`serviceProcessInstaller1`のプロパティで、Windowsサービスの実行アカウントを「User」にすると、
![イメージ](/blog/assets/img/2023-03-02/Windowsサービス_実行アカウント1.png)<br>
`installutil`実行時にユーザーの入力ダイアログが表示されます。<br>
![イメージ](/blog/assets/img/2023-03-02/Windowsサービス_実行アカウント2.png)
...
![イメージ](/blog/assets/img/2023-03-02/Windowsサービスのイベント可否1.png)<br>
使用する（True）になっていると、Windowsサービスのプロパティからイベントが選択できるようになります。<br>
![イメージ](/blog/assets/img/2023-03-02/Windowsサービスのイベント可否2.png)<br>
...
![イメージ](/blog/assets/img/2023-03-02/Windowsサービス_アプリ作成.png)
...
![イメージ](/blog/assets/img/2023-03-02/Windowsサービスのデバッグ.png)

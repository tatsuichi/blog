...
# SQLの呼び出し方
![イメージ](/blog/assets/img/SQLの呼び出し方.drawio.png)

## 静的プレースホルダ
![イメージ](/blog/assets/img/静的プレースホルダ.png)

## 動的プレースホルダ
![イメージ](/blog/assets/img/動的プレースホルダ.png)

## 参考サイト
+ [安全なSQLの呼び出し方](https://www.ipa.go.jp/security/vuln/websecurity/ug65p900000196e2-att/000017320.pdf)

# 「ストアドプロシージャ」と「プリペアドステートメント」
![イメージ](/blog/assets/img/「ストアドプロシージャ」と「プリペアドステートメント」のイメージ図.png)

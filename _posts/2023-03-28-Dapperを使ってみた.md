...
![イメージ](/blog/assets/img/2023-03-28/ORMapper_Dapper開発手法.png)
...
## 構成
![イメージ](/blog/assets/img/2023-03-28/ORMapper_Dapper構成.png)

## プロジェクト作成
プロジェクトテンプレートは「ASP.NET Core Webアプリ（Model-View-Controller）」を選択します。<br>
![イメージ](/blog/assets/img/2023-03-28/ORMapeer_Dapperプロジェクト作成.png)<br>

プロジェクト名は`WebApplicationDapper`にします。<br>
![イメージ](/blog/assets/img/2023-03-28/ORMapper_プロジェクト名.png)

## Webサイトのスタイル設定
サイトのホームページ、レイアウト、メニューを設定します。

**スタイル変更前（デフォルト）**<br>
![イメージ](/blog/assets/img/2023-03-28/ORMapper_スタイル変更前.png)<br>

**スタイル変更後**<br>
![イメージ](/blog/assets/img/2023-03-28/ORMapper_スタイル変更後.png)<br>
...
![イメージ](/blog/assets/img/2023-03-28/ORMapper_ER.png)
```text
Models
 ├─ Course.cs         // 新規に追加する
...
![イメージ](/blog/assets/img/2023-03-28/ORMapper_スキャフォールディングEFCore1.png)<br>
「読み取り/書き込みアクションがあるMVCコントローラー」を選択します。<br>
![イメージ](/blog/assets/img/2023-03-28/ORMapper_スキャフォールディング_コントローラーの追加1.png)<br>
ファイル名を、`StudentController.cs`にします。<br>
![イメージ](/blog/assets/img/2023-03-28/ORMapper_スキャフォールディング_コントローラーの追加2.png)<br>
...
![イメージ](/blog/assets/img/2023-03-28/ORMapper_スキャフォールディングEFCore1.png)<br>
「Razorビュー」を選択します。<br>
![イメージ](/blog/assets/img/2023-03-28/ORMapper_スキャフォールディング_ビューの追加1.png)<br>
...
<br>
![イメージ](/blog/assets/img/2023-03-28/ORMapper_スキャフォールディング_ビューの追加2.png)
...
![イメージ](/blog/assets/img/2023-03-28/ORMapper_データベース追加.png)<br>

データベース名は`WebApplicationDapper`にします。<br>
![イメージ](/blog/assets/img/2023-03-28/ORMapper_データベース名.png)

### テーブル作成＋データ投入
Visual Studioの「SQL Serverオブジェクトエクスプローラー」で先ほど作成したデータベース`WebApplicationDapper`を右クリックして「新しいクエリ」を選択します。<br>
![イメージ](/blog/assets/img/2023-03-28/ORMapper_クエリ.png)<br>
...
## Webアプリの実行
新たにレコードを追加します。<br>
![イメージ](/blog/assets/img/2023-03-28/ORMapper_Dapper_Webアプリ実行結果1.png)<br>
![イメージ](/blog/assets/img/2023-03-28/ORMapper_Dapper_Webアプリ実行結果2.png)<br>
![イメージ](/blog/assets/img/2023-03-28/ORMapper_Dapper_Webアプリ実行結果3.png)<br>

「SQL Serverオブジェクトエクスプローラー」で`dbo.Student`を右クリックして「データの表示」を選択します。<br>
![イメージ](/blog/assets/img/2023-03-28/ORMapper_Webアプリ実行結果2.png)<br>
![イメージ](/blog/assets/img/2023-03-28/ORMapper_Dapper_Webアプリ実行結果4.png)<br>

新たにレコードが追加されたことの確認ができました。<br>
ヘッダーの「About」「Courses」「Instructors」「Departments」は、今回は実装しません。クリックすると404エラーとなります。<br>
![イメージ](/blog/assets/img/2023-03-28/ORMapper_未実装.png)
...
![イメージ](/blog/assets/img/2023-03-28/ORMapper_解析_リファクタリング.png)
